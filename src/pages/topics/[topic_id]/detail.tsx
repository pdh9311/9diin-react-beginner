    ...
    <main className="w-full h-full min-h-[720px] flex flex-col">
      <div className="relative w-full h-60 md:h-100 bg-cover bg-[50%_35%] bg-accent" style={{ backgroundImage: `url(${thumbnail})` }}>
        ...
        <div className="absolute top-4 left-6 z-10 flex items-center gap-2">
          <Button variant="outline" size="icon" className="" onClick={() => nav("/")}>
            <ArrowLeft />
          </Button>
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                ...
                <AlertDialogFooter>
                  ...
                  <AlertDialogAction className="bg-red-800/50 text-foreground hover:bg-reg-900/50" onClick={handleDelete}>
                    삭제
                  </AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
      ...
      <section className="relative w-full flex flex-col items-center align-center -mt-40">
      ...
      {/* 에디터 내용을 불러와 렌더링 */}
      <div className="w-full  py-6">{content && <AppEditor props={JSON.parse(content)} readonly />}</div>
    </main>
  );
};
